...
**Overall status:** `DONE` — RR-01 through RR-08 are all `DONE`.
**Both platforms are live**: Android on Google Play since 2026-08-13,
iOS on the App Store since 2026-08-18. Version 1.0.0 has shipped. This
release-readiness cycle is complete and archived — see
`BACKLOG_ARCHIVE_2026-08-18.md`.
...
RR-01 through RR-08 are all `DONE`. Both platforms are live: Android
since 2026-08-13, iOS since 2026-08-18. Version 1.0.0 has shipped and
this release-readiness cycle is complete.
...
**Completion:** 2026-08-18. All 11 checklist items complete. Release
notes, privacy/support/beta-testing (byproducts of RR-07's
store-listing work), and both store submissions are done — Android and
iOS are both **live**: Android since 2026-08-13, iOS since 2026-08-18.
...
- [x] Archive the completed release-readiness backlog and acceptance
      evidence. See `BACKLOG_ARCHIVE_2026-08-18.md`.
